-- ============================================================
-- MIGRACIÓN: deliver_order ahora guarda firma digital + quién recibió
...
begin
  ...
  set status = 'entregado',
      signature_data = coalesce(p_signature, signature_data),
...
grant execute on function deliver_order(uuid, text, text) to authenticated;
